...
class DPT():
    def __init__(self, task='depth', device='cuda'):
        ...
        if task == 'depth':
            path = '/home/data/lyk/dreamfusion/pretrained/omnidata/omnidata_dpt_depth_v2.ckpt'
            ...
            path = '/home/data/lyk/dreamfusion/pretrained/omnidata/omnidata_dpt_normal_v2.ckpt'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--size', default=256, type=int, help="output resolution") # 512
